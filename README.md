# Data science study: avocado project
...
Description *copied from Kaggle page*
...
My study goals
- Try various visualization to capture the data set 
- Pull insights from the visualization
- Build ML Model 
